    ...
    <div className="arc-hud-panel pointer-events-auto absolute bottom-4 right-4 z-30 flex flex-col gap-1 rounded-xl p-1.5">
      <div className="arc-hud-content flex items-center justify-center gap-1">
        ...
        <Tooltip content={t("map.controls.zoomOut")}>
          <button onClick={onZoomOut} className="map-btn" aria-label={t("map.controls.zoomOut")}>
            <Minus size={16} />
          </button>
        </Tooltip>
        <Tooltip content={t("map.controls.resetView")}>
          <button onClick={onResetView} className="map-btn" aria-label={t("map.controls.resetView")}>
            <LocateFixed size={16} />
          </button>
        </Tooltip>
