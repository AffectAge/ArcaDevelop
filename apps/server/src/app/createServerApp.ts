...
export function createServerApp(options: { dataRoot: string }): express.Express {
  ...
  const serveScenarioAssets = (assetFolder: "uploads" | "buildings" | "cities" | "features" | "units" | "utils") => (req: express.Request, res: express.Response, next: express.NextFunction) => {
