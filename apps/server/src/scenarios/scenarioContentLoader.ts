...
export const scenarioContentFileNames = [
  ...
  ["provinceTypes", ["province_types.json", "provinceTypes.json"]],
  ["provinceClimates", ["province_climates.json", "provinceClimates.json"]],
  ["provinceLandscapes", ["province_landscapes.json", "provinceLandscapes.json"]],
  ["provinceContinents", ["province_continents.json", "provinceContinents.json"]],
  ["provinceStrategicRegions", ["province_strategic_regions.json", "provinceStrategicRegions.json"]],
