    ...
    for (const country of countries) {
      await params.prisma.country.upsert({
        ...
        create: {
          ...
          cultureId: `culture:${country.id}`,
          cultureName: `${country.name} Culture`,
          cultureColor: country.color,
          cultureLogoUrl: country.crestUrl,
          religionId: `religion:${country.id}`,
          religionName: `${country.name} Faith`,
          religionColor: country.color,
          religionLogoUrl: country.crestUrl,
