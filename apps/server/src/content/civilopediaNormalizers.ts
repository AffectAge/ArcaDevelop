...
export function defaultCivilopediaEntries(): GameSettings["civilopedia"]["entries"] {
  return [
    ...
    },
    {
      ...
      title: "Колонизация гексов",
      summary: "Гонка стран за свободные гекса с прогрессом, стоимостью и поддержкой.",
      keywords: ["колонизация", "гекса", "прогресс", "гонка"],
      imageUrl: null,
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Стоимость колонизации зависит от площади гекса и глобальных ставок за 1000 км², если не задана ручная цена.",
      ...
      sections: [
        {
          ...
          paragraphs: [
            ...
            "Отдельная кнопка включает/отключает границы гексов.",
          ],
        },
      ],
    },
